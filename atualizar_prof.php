...
try {
    ...
    if (isset($_GET['id'])) {
        ...
        $stmt = $conn->prepare('SELECT usuarios.id, usuarios.nome, usuarios.email, disciplinas.id AS disciplina_id, disciplinas.nome AS disciplina_nome 
                                 FROM usuarios 
...
<body>
    ...
    <form action="funcoes_prof/upd_prof.php" method="POST">
